...
**
** Created: Mon Nov 11 16:35:57 2013
...
public:
    ...
    void setupUi(QDialog *ConfigDialog)
    {
        ...
        gridLayout->addWidget(label_minScale, 2, 0, 1, 1);
        ...
        gridLayout->addWidget(lineEdit_maxScale, 3, 1, 1, 1);
        ...
        gridLayout->addWidget(label_numberOfFeatures, 4, 0, 1, 1);
        ...
        gridLayout->addWidget(lineEdit_numberOfFeatures, 4, 1, 1, 1);
        ...
        gridLayout->addWidget(label_numberOfTrees, 5, 0, 1, 1);
        ...
        gridLayout->addWidget(lineEdit_minSize, 6, 1, 1, 1);
        ...
        gridLayout->addWidget(groupBox_proportionalShift, 1, 0, 1, 1);
    ...
    {
        ConfigDialog->setWindowTitle(QApplication::translate("ConfigDialog", "Tracker Configuration", 0, QApplication::UnicodeUTF8));
        ...
        groupBox_proportionalShift->setTitle(QApplication::translate("ConfigDialog", " Shift", 0, QApplication::UnicodeUTF8));
